...
public interface UserService extends Service<User> {
	 ...
	 * 判断指定的用户是否是根域的管理员用户。
	 * 
	 * @param role 指定用户。允许null，将始终返回false。
	 * @return
	 */
	 ...
	 * 根据登录名取得可用的用户。
	 * 
	 * @param domainUuid 指定用户所属域的uuid。
	 * @param login 指定用户的登录名。
	 * @param fetchProps
	 ...
	 * 修改用户口令。
	 * 
	 * @param userUuid 指定被修改用户的uuid。不允许null。
	 * @param oldPassword 指定原口令。不允许null。
	 * @param newPassword 指定新口令。不允许null。
	 */
	 ...
	 * 赋予用户指定的角色。
	 * 
	 * @param userUuid 指定被修改的用户的uuid。不允许null。
	 * @param userOca
	 * @param roleUuids 指定被赋予的角色的uuid。不允许null。
	 */
	 ...
	 * @param userUuid 指定被修改的用户的uuid。不允许null。
	 * @param userOca
	 * @param roleUuids 指定被删除的角色的uuid。不允许null。
	 */
	 ...
	 * @param userUuid 指定被修改的用户的uuid。不允许null。
	 * @param userOca
	 * @param permCodes 指定被赋予的权限代码集合。不允许null。
	 * @param operCtx
	 * @throws BusinessException
	 */
	 ...
	 * @param userUuid 指定被修改的用户的uuid。不允许null。
	 * @param userOca
	 * @param permCodes 指定将被删除的权限代码集合。不允许null。若指定的权限代码不存在，将被忽略。
	 */
